 ...
 */
// 1
var shopItemsArray =  ["Brown Rice", "Poha", "Eggs", "Pulses"]
var shopItemsDictionary = ["Brown Rice": 50, "Poha": 24, "Eggs": 20, "Pulses":10]

// 2
shopItemsArray.contains("Chicken")

// 3
shopItemsArray.insert("Chicken", at: 3)
...
// 6
var fullArmorSet : Set = ["Hands", "Helmet", "Armor", "Spear"]
var currentArmorSet: Set = ["Helmet", "Armor"]

// 7
var missingArmorSet = fullArmorSet.subtracting(currentArmorSet)


// 8
var armorPieceTuple = (name : "Sensehack", cost : 978, canEquip : true)
